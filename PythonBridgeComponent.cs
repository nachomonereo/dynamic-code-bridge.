...
".Replace("{shortId}", shortId);
        ...
        protected override void AppendAdditionalComponentMenuItems(ToolStripDropDown menu)
        {
            ...
            Menu_AppendItem(menu, "Copy code for Python Native", (s, e) => {
                CopyToClipboard();
            });
        ...
        private void CopyToClipboard()
        {
            try
            {
                string header = "# --- DYNAMIC CODE BRIDGE EXPORT ---\n" +
                                "# To use this code in a native Grasshopper Python component:\n" +
                                "# 1. Create the matching Inputs and Outputs on the native component.\n" +
                                "# 2. Copy everything below into the Python Script editor.\n" +
                                "#\n\n";
            ...
            {
                System.Windows.Forms.MessageBox.Show("Failed to copy to clipboard: " + ex.Message, "Export Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
            }
        }
    }
