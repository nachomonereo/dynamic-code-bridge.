...
"""
===========================================================================
DYNAMIC PYTHON BRIDGE - MASTER MANUAL & AI SYSTEM PROMPT v1.6.2
===========================================================================
...
KEY CAPABILITIES OF THIS PLUGIN (FOR AI CONTEXT):
- Instant Live-Sync: Saving the file re-compiles and updates Grasshopper in milliseconds.
- Script Internalization: Code can be internalized directly into the GH component to make it standalone.
- Deep Diagnostics: Generates detailed .log files with stack traces and variable snapshots.
- Auto-Generated Inputs: Add [slider], [boolean], etc. to # IN tags. UI is generated by right-clicking the component and selecting 'Generate Missing Sliders'.

RULES FOR GENERATING CODE:
1. PARAMETERS: Use # IN: Name or # OUT: Name at the top.
   - Supported input types: [slider], [boolean], [color], [point], [plane], [text].
2. LIBRARIES: Import 'Rhino.Geometry as rg'. You can auto-install packages with '# r: package_name'.
3. DATA ACCESS: Use the 'Inputs' dictionary. Always start with 'Inputs = dict(Inputs)' for compatibility.
