...
".Replace("{shortId}", shortId);
        ...
        private void ExportToUserObject()
        {
            try
            {
                Guid csharpGuid = new Guid("86B0E0DF-9B5A-4361-9EBC-61563F8AD207");
                var nativeComp = Grasshopper.Instances.ComponentServer.EmitObject(csharpGuid) as IGH_Component;
                if (nativeComp == null) {
                    throw new Exception("Could not instantiate the native Grasshopper C# component.");
                }
                ...
                string codeToInject = _lastCode + "\r\n\r\nCodeOut = @\"" + _lastCode.Replace("\"", "\"\"") + "\";";
                dynamic dynComp = nativeComp;
                dynComp.ScriptSource.ScriptCode = codeToInject;
                ...
                userObj.Description.Description = "Standalone script generated by Dynamic Code Bridge.\nCredits: Robots Lab and IAAC. Author: Nacho Monereo.";
                userObj.Description.Category = "IAAC";
                userObj.Description.SubCategory = "CS Script";
